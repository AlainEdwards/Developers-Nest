          				...
          				<div class="navbar-inner">
            				...
            				<div class="nav-collapse collapse">
              					<ul class="nav">
                					...
                					<li class="active"><a href="index.php">Code</a></li>
                					...
                					<li class="dropdown">
                  					...
                  					<ul class="dropdown-menu">
										...
										echo "<li><a href='submit.php'>Submit Code</a></li>";
    ...
    <div class="container">
    	<div id="main">
    		...
    		<div id="mbottom">   	
            	...
            	<div id="codeoftheday">
                	<h3><u>Code Submission of the day:</u></h3>
					...
					$result = mysql_query("SELECT * FROM code_post WHERE COD='Y'",$con);
					
					while($row = mysql_fetch_array($result))
					{
						echo "<div id='recentcode'>";
						echo "<h4><a href='code.php?title=" . $row['Title'] . "'>" . $row['Title'] .  "</a></h4>";
						echo "<hr>";
            	...
            	<div id="recentcode">
                	<h3><u>Recent Code Submissions:</u></h3>

                    
                    <?php
					
					$result = mysql_query("SELECT * FROM code_post ORDER BY Date DESC LIMIT 0, 3",$con);
                ...
                <div id="oldcode">
                	<h3><u>Old Code Submissions:</u></h3>

                    
                    <?php
					
					
					$result = mysql_query("SELECT * FROM code_post WHERE Date < '2013-01-01' ORDER BY Date DESC LIMIT 0, 3",$con);
