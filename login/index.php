...
<html>
  ...
  <body>
    ...
    <div class="container">
        ...
        <h2 class="form-signin-heading">Member Login: </h2><a class="error"><?php if(!empty($_GET["Err"]) && $_GET["Err"] == "wp"){echo "Wrong Username or Password";}if(!empty($_GET["Err"]) && $_GET["Err"] == "sc"){echo "You must be logged in, in order to submit code";}if(!empty($_GET["Err"]) && $_GET["Err"] == "edit"){echo "You must be logged in, in order to edit your profile";}?></a>
