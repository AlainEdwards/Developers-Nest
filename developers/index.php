    	...
    	<div id="main">
    		...
    		<div id="mbottom">  
                ...
                <?php
					...
					$result = mysql_query("SELECT * FROM $table ORDER BY user",$con);
					...
					while($row = mysql_fetch_array($result))
					{
							...
							echo "<div id='image'>";
							echo "<a href='../users/profile.php?user=" . $row['user'] . "'><center><img src='" . $row['img'] . "'/></center></a>";
							echo "</div>";
             ...
             <div id="whos_online">
                ...
                <?php
					...
					while($row = mysql_fetch_array($result))
					{
							...
							echo "<a href='../users/profile.php?user=" . $row['user'] . "'><center><img src='" . $row['img'] . "'/></center></a>";
							echo "</div>";
							echo "<p><a href='../users/profile.php?user=" . $row['user'] . "'>" . $row['user'] . "</a></p>";
