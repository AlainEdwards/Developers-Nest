    	...
    	<div id="main">
    		...
    		<div id="mbottom">   	
            	...
            	<div id="recentcode">
					...
					$result = mysql_query("SELECT * FROM code_post ORDER BY Date DESC LIMIT 0, 10",$con);
					
					while($row = mysql_fetch_array($result))
					{
						echo "<div id='recentcode'>";
						echo "<h4><a href='code/code.php?title=" . $row['Title'] . "'>" . $row['Title'] .  "</a></h4>";
						echo "<hr>";
